...
const EMOJI_CATEGORIES: { name: string; emojis: string[] }[] = [
  ...
  },
  {
    ...
    emojis: [
      ...
      "\u{1F99E}", "\u{1F980}", "\u{1F419}", "\u{1F41A}", "\u{1F40C}", "\u{1F997}",
      "\u{1F577}\uFE0F", "\u{1F982}", "\u{1F99A}", "\u{1F9A9}",
      "\u{1F340}", "\u{1F339}", "\u{1F33B}", "\u{1F337}", "\u{1F33A}", "\u{1F338}",
      "\u{1F332}", "\u{1F333}", "\u{1F334}", "\u{1F335}", "\u{1F33F}", "\u{1F341}",
    ],
  },
  {
    name: "Food",
    emojis: [
      ...
      "\u{1F369}", "\u{1F9C1}", "\u{1F9C0}", "\u{1F37F}",
      "\u2615", "\u{1F375}", "\u{1F37A}", "\u{1F37B}", "\u{1F377}", "\u{1F378}",
      "\u{1F379}", "\u{1F37E}", "\u{1F9C3}", "\u{1F964}", "\u{1F9CB}", "\u{1F9C9}",
    ],
  },
  {
    name: "Travel",
    emojis: [
      ...
      "\u{1F3CD}\uFE0F", "\u{1F6B2}", "\u{1F6A8}", "\u{1F691}", "\u{1F692}", "\u{1F690}",
      "\u2708\uFE0F", "\u{1F680}", "\u{1F6F8}", "\u{1F6F6}", "\u26F5", "\u{1F6A2}",
      "\u{1F3E0}", "\u{1F3E2}", "\u{1F3E5}", "\u{1F3EB}", "\u{1F3ED}", "\u{1F3F0}",
      "\u26EA", "\u{1F5FC}", "\u{1F5FD}", "\u{1F5FF}", "\u{1F3D4}\uFE0F", "\u{1F30B}",
      "\u{1F3D6}\uFE0F", "\u{1F3DD}\uFE0F", "\u{1F3DE}\uFE0F", "\u{1F305}", "\u{1F304}",
      "\u{1F307}", "\u{1F306}", "\u{1F303}", "\u{1F309}", "\u{1F301}",
    ],
  },
  {
    name: "Activities",
    emojis: [
      "\u26BD", "\u{1F3C0}", "\u{1F3C8}", "\u26BE", "\u{1F3BE}", "\u{1F3D0}",
      "\u{1F3C9}", "\u{1F3B1}", "\u{1F3D3}", "\u{1F3F8}", "\u{1F94A}", "\u{1F945}",
      "\u26F3", "\u{1F3BF}", "\u{1F3C2}", "\u{1F3CB}\uFE0F", "\u{1F93A}", "\u{1F93C}",
      "\u{1F3C6}", "\u{1F3C5}", "\u{1F947}", "\u{1F948}", "\u{1F949}", "\u{1F396}\uFE0F",
      "\u{1F3A8}", "\u{1F3AD}", "\u{1F3AC}", "\u{1F3A4}", "\u{1F3A7}", "\u{1F3B5}",
      "\u{1F3B6}", "\u{1F3B8}", "\u{1F3B9}", "\u{1F3BB}", "\u{1F941}", "\u{1FA98}",
      "\u{1F3AE}", "\u{1F3AF}", "\u{1F3B0}", "\u{1F9E9}",
    ],
  },
  {
    name: "Objects",
    emojis: [
      "\u{1F4F1}", "\u{1F4BB}", "\u{1F5A5}\uFE0F", "\u{1F4F7}", "\u{1F4F8}", "\u{1F4F9}",
      "\u{1F4FA}", "\u{1F4FB}", "\u260E\uFE0F", "\u{1F50B}", "\u{1F50C}", "\u{1F4A1}",
      "\u{1F526}", "\u{1F56F}\uFE0F", "\u{1F4B0}", "\u{1F4B3}", "\u{1F48E}", "\u{1F4E6}",
      "\u{1F4DD}", "\u{1F4CB}", "\u{1F4CC}", "\u{1F4CE}", "\u{1F587}\uFE0F", "\u{1F4DA}",
      "\u{1F4D6}", "\u{1F517}", "\u{1F527}", "\u{1F528}", "\u{1F6E0}\uFE0F", "\u{1F529}",
      "\u{1F512}", "\u{1F513}", "\u{1F514}", "\u{1F515}", "\u{1F50D}", "\u{1F52C}",
      "\u{1F52D}", "\u{1F4E1}", "\u{1F489}", "\u{1F48A}", "\u{1FA79}", "\u{1F6D2}",
  ...
  },
  {
    ...
    emojis: [
      ...
      "\u{1F319}", "\u{1F308}", "\u2601\uFE0F", "\u{1F4A7}", "\u2744\uFE0F", "\u{1F4A8}",
      "\u2705", "\u274C", "\u2753", "\u2757", "\u{1F4AF}", "\u{1F6AB}",
      "\u26D4", "\u{1F6A8}", "\u267B\uFE0F", "\u2622\uFE0F",
      "\u{1F534}", "\u{1F7E0}", "\u{1F7E1}", "\u{1F7E2}", "\u{1F535}", "\u{1F7E3}",
      "\u26AB", "\u26AA", "\u{1F7E4}", "\u{1F533}", "\u{1F532}",
      "\u25B6\uFE0F", "\u23F8\uFE0F", "\u23F9\uFE0F", "\u23FA\uFE0F",
      "\u{1F3F3}\uFE0F", "\u{1F3F4}", "\u{1F3C1}",
    ],
  },
  {
    name: "Flags",
    emojis: [
      ...
      "\u{1F1E8}\u{1F1F3}", "\u{1F1EE}\u{1F1F3}", "\u{1F1E7}\u{1F1F7}", "\u{1F1F2}\u{1F1FD}",
      "\u{1F1EE}\u{1F1F9}", "\u{1F1EA}\u{1F1F8}", "\u{1F1F7}\u{1F1FA}", "\u{1F1F3}\u{1F1F1}",
      "\u{1F1F8}\u{1F1EA}", "\u{1F1F3}\u{1F1F4}", "\u{1F1E8}\u{1F1ED}", "\u{1F1E6}\u{1F1F7}",
      "\u{1F1F5}\u{1F1F1}", "\u{1F1F9}\u{1F1F7}", "\u{1F1EE}\u{1F1EA}", "\u{1F1F5}\u{1F1F9}",
    ],
  },
];
